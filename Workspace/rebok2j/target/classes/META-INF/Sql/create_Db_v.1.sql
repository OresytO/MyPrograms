...
CREATE SCHEMA IF NOT EXISTS `rebok2j`
...
CREATE TABLE IF NOT EXISTS `Staff` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `drivingLicense` VARCHAR(255) NULL DEFAULT NULL, `firstName` VARCHAR(255) NULL DEFAULT NULL, `lastName` VARCHAR(255) NULL DEFAULT NULL, `passport` VARCHAR(255) NULL DEFAULT NULL, `powerToSign` TINYINT(1) NULL DEFAULT '0', PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `idTypes` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `idName` VARCHAR(255) NULL DEFAULT NULL, PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `Locations` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `locationName` VARCHAR(255) NULL DEFAULT NULL, PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `DeliveriesTypes` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `type` VARCHAR(255) NULL DEFAULT NULL, PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `Roles` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `roleName` VARCHAR(255) NULL DEFAULT NULL, PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `Users` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT, `enabled` TINYINT(1) NULL DEFAULT '0', `password` VARCHAR(255) NULL DEFAULT NULL, `userName` VARCHAR(255) NULL DEFAULT NULL, `userNickname` VARCHAR(255) NULL DEFAULT NULL, PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `UsersRoles` (`role_id` BIGINT(20) NOT NULL, `user_id` BIGINT(20) NOT NULL, PRIMARY KEY (`role_id`, `user_id`), INDEX `FK_users_roles_user_id` (`user_id` ASC), CONSTRAINT `FK_users_roles_role_id` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`), CONSTRAINT `FK_users_roles_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8;
USE `rebok2j`;
