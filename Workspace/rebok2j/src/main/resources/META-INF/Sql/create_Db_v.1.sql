...
CREATE TABLE IF NOT EXISTS `Autorizations` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT,`AutorizationCode` VARCHAR(255) NULL DEFAULT NULL,`creationDate` VARCHAR(255) NULL DEFAULT NULL,`dateOfAutorization` VARCHAR(255) NULL DEFAULT NULL,`forwarderId` BIGINT(20) NOT NULL,`signedPersonId` BIGINT(20) NOT NULL,PRIMARY KEY (`id`),INDEX `FK_Autorizations_forwarderId` (`forwarderId` ASC),INDEX `FK_Autorizations_signedPersonId` (`signedPersonId` ASC),CONSTRAINT `FK_Autorizations_signedPersonId`FOREIGN KEY (`signedPersonId`)REFERENCES `staff` (`id`),CONSTRAINT `FK_Autorizations_forwarderId`FOREIGN KEY (`forwarderId`)REFERENCES `staff` (`id`))ENGINE = InnoDB DEFAULT CHARACTER SET = utf8;
