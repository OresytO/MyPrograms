...
{
	String sql_str;
    sql_str = "INSERT INTO payment (payment) VALUES ('готівковий');";
	ADOCommand1->CommandText = sql_str;
    ADOCommand1->Execute();
    sql_str = "INSERT INTO payment (payment) VALUES ('безготівковий');";
	ADOCommand1->CommandText = sql_str;
    ADOCommand1->Execute();

    sql_str = "INSERT INTO status (status) VALUES ('так');";
	ADOCommand1->CommandText = sql_str;
    ADOCommand1->Execute();
    sql_str = "INSERT INTO status (status) VALUES ('ні');";
	ADOCommand1->CommandText = sql_str;
    ADOCommand1->Execute();
}
//---------------------------------------------------------------------------
