...
Begin VB.Form frmDrives 
   ...
   Caption         =   "Work with Drive Objects"
   ClientHeight    =   4530
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5970
...
Private Sub Form_Load()
    ...
    ' drive is a UNC drive. That's why
    ' we added the "On Error Resume Next"
    ' in here.
...
Private Function DriveType( _
 lngType As Scripting.DriveTypeConst) As String
    Select Case lngType
        Case Fixed
            DriveType = "Fixed"
        Case Remote
