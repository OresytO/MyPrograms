...
Begin {AC0714F6-3D04-11D1-AE7D-00A0C90F26F4} Addin 
   ...
   _ExtentY        =   12912
   _Version        =   393216
   Description     =   "VBA IDE Add-In that lists projects, modules, and procedures"
   DisplayName     =   "VBA IDE Add-In"
...
Public Sub Show()
    ...
    ' Refresh the lists of projects, etc.
    mfrmAddin.RefreshLists
